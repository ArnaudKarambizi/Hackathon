...
import { faRunning, faDumbbell, faUser } from '@fortawesome/free-solid-svg-icons';
                    ...
                    <div className="intro-left">
                        <div>
                            <div>
                                ...
                                <p className="intro-desc">LifeSports is a non-profit program in Charlotte that combines education, mentorship, and sports to empower young kids to become the best they can be.</p>
